...
namespace Simple
{
	public class Startup
	{
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
			...
			{
				// Default limit was changed some time ago. Should work by setting MaxRequestBodySize to null
				// using ConfigureKestrel but this does not seem to work for IISExpress.
