...
namespace Simple.Extensions.vshistory.CreateTusConfigurationExtension.cs
{
	public class CreateTusConfigurationExtension
	{
		public static IServiceCollection AddCreateTusConfiguration(this IServiceCollection services, IConfiguration configuration)
		{

		}

		private DefaultTusConfiguration CreateTusConfiguration(IServiceProvider serviceProvider, IConfiguration configuration)
		{
