...
namespace Simple.Extensions.vshistory.CreateTusConfigurationExtension.cs
{
	...
	{
		public static IServiceCollection AddCreateTusConfiguration(this IServiceCollection services)
		{
		...
		private DefaultTusConfiguration CreateTusConfiguration(IServiceProvider serviceProvider)
		{
			...
			bool enableAuthorize = serviceProvider.GetService<IConfiguration>().GetValue<bool>("EnableOnAuthorize");
