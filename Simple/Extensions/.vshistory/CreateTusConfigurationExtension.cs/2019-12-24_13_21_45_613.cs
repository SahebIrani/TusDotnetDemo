...
namespace Simple.Extensions
{
	public static class CreateTusConfigurationExtension
	{
		...
		{
			ILogger<Startup> logger = serviceProvider.GetService<ILoggerFactory>()
				.CreateLogger<Startup>();

			bool enableAuthorize = serviceProvider.GetService<IConfiguration>()
				.GetValue<bool>("EnableOnAuthorize");
