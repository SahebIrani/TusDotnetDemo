...
namespace Simple.Endpoints.vshistory.DownloadFileEndpoint.cs
{
	public static class DownloadFileEndpoint
	{
		...
		{
			if (metadata.TryGetValue("contentType", out var metadataContentType))
				return metadataContentType.GetString(Encoding.UTF8);
